...
<form class="ui form segment">
  ...
  <div class="two fields">
    <div class="field">
      ...
      <input id="name" placeholder="Primeiro Nome" name="name" type="text">
    </div>

     <div class="field">
      <label for="fantasia">Nome fantasia * </label>
      <input  id="fantasia" placeholder="Nome fantasia" name="fantasia" type="text">
    </div>
     </div>

     <div class="field">
      <label for="telefone">Telefone do Estabelecimento *</label>
      <input id="telefone" placeholder="Telefone" name="telefone" type="text" maxlength="14">
    </div>
...
maxlength="18" onBlur="ValidarCNPJ(form.cnpj);" >
    ...
    <div class="five wide field">
      <input type="text"  name="cep" placeholder="Cep" onKeyPress="MascaraCep(form.cep);"
 maxlength="10" onBlur="ValidaCep(form.cep)">
  ...
  <div class="two fields">
    <div class="field">
      ...
      <input id="tempoentregas" placeholder="Há quanto tempo faz entregas?" name="tempoEntregas" type="text">
    </div>

     <div class="field">
      <label for="entregaMes">Quantidade média de entregas por mês? * </label>
      <input id="entregaMes" placeholder="Quantidade média de entregas por mês?" name="mediaEntrega" type="text">
    </div>
     </div>

     <div class="field">
      <label for="veiculosentrega" >Quantidade de veículos para entrega?  *</label>
      <input id="veiculosentrega" placeholder="Quantidade de veículos para entrega?" name="qntdVeiculos" type="text">
    </div>

     <div class="field">
      <label for="quantidadeentrega">Tempo médio de entrega*</label>
      <input id="quantidadeentrega"  placeholder="Tempo médio de entrega" name="tempoMedioEntregas" type="text">
    </div>
